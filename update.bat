rem update tiles ----------------------------------------------
curl -k -L -O https://github.com/lancard/tile-server/archive/refs/heads/master.zip
...
curl -k -L -O https://cdn.jsdelivr.net/npm/bootstrap/dist/js/bootstrap.bundle.min.js
...
curl -k https://raw.githubusercontent.com/lancard/korea-flight-database/master/database/navaid.json >> .\app\src\main\assets\www\database\navaid.js
curl -k https://raw.githubusercontent.com/lancard/korea-flight-database/master/database/procedure.json >> .\app\src\main\assets\www\database\procedure.js